...
import develop.software.cbay.eftwiki.weapon.WeaponFragment;
...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        displaySelectedScreen(firstItem, R.id.nav_weapons);*/
    }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        displaySelectedScreen(item, item.getItemId());

        return true;
    }

    private void displaySelectedScreen(MenuItem item, int itemId) {
